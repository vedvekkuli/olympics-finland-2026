...
const olympicSchedule = [
    ...
    // ========== SUNNUNTAI 15.2. ==========
    {
        ...
        events: [
            ...
            { time: '12:15', sport: 'ampumahiihto', name: 'M Takaa-ajo 12,5 km', detail: 'Tero Seppälä, Olli Hiidensalo, Otto Invenius, Tuomas Harjula', medal: true, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-76768443' },
            ...
            { time: '15:45', sport: 'ampumahiihto', name: 'N Takaa-ajo 10 km', detail: 'Inka Hämäläinen, Venla Lehtonen, Sonja Leinamo, Suvi Minkkinen', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768438' },
            ...
            { time: '19:45', sport: 'makihyppy', name: 'N Suurmäki', detail: 'Heta Hirvonen, Minja Korhonen, Sofia Mattila, Jenny Rautionaho', medal: true, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77074324' },
            { time: '20:05', sport: 'curling', name: 'M Alkusarja', detail: '🇨🇳–🇨🇦, 🇳🇴–🇺🇸, 🇮🇹–🇨🇿, 🇬🇧–🇨🇭', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'] },
