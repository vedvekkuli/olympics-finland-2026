...
const olympicSchedule = [
    ...
    // ========== TIISTAI 10.2. ==========
    {
        ...
        events: [
            ...
            { time: '14:09', sport: 'maastohiihto', name: 'N Sprintti (p), finaali', detail: 'Johanna Matintalo?', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'] },
            { time: '14:21', sport: 'maastohiihto', name: 'M Sprintti (p), finaali', detail: '', medal: true, finnish: false, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'] },
