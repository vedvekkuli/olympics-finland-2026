...
// Last update: To 19.2.2026 – Välierät: Kanada–Suomi pe 17:40! USA 1-0 Ruotsi, kaikki puolivälierätulokset
// ============================================
...
const olympicSchedule = [
    ...
    // ========== KESKIVIIKKO 18.2. - SUOMI JATKOON! ==========
    {
        ...
        events: [
            ...
            { time: '22:10', sport: 'jaakiekko-miehet', name: '🇺🇸–🇸🇪', detail: 'Puolivälierä – USA 1-0 (0-0,1-0,0-0, Larkin 31:03)', medal: false, finnish: false, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77075298' },
    ...
    // ========== TORSTAI 19.2. - NAISTEN LOPPUKILPAILUT ==========
    {
        ...
        events: [
            ...
            { time: '11:00', sport: 'yhdistetty', name: 'M Parisprintti, mäkiosuus', detail: 'Eero Hirvonen / Ilkka Herola', medal: false, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76771601' },
            ...
            { time: '15:00', sport: 'yhdistetty', name: 'M Parisprintti, hiihto-osuus', detail: 'Eero Hirvonen / Ilkka Herola', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76771598' },
            { time: '15:05', sport: 'curling', name: 'N Alkusarja', detail: '🇨🇭–🇺🇸, 🇨🇦–🇰🇷, 🇯🇵–🇨🇳, 🇬🇧–🇮🇹', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'] },
            { time: '15:40', sport: 'jaakiekko-naiset', name: 'Pronssiottelu: 🇨🇭–🇸🇪', detail: '', medal: true, finnish: false, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77075344' },
