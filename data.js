...
const olympicSchedule = [
    ...
    // ========== LAUANTAI 7.2. - ENSIMMÄISET LOPPUKILPAILUT ==========
    {
        ...
        events: [
            ...
            { time: '14:00', sport: 'maastohiihto', name: 'N Yhdistelmäkilpailu 20 km', detail: 'Kaikki suomalaisnaiset', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768176' },
            ...
            { time: '19:45', sport: 'makihyppy', name: 'N Normaalimäki', detail: 'Suomen naishyppääjät', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-76891310' },
            { time: '20:05', sport: 'curling', name: 'Sekajoukkue, alkusarja', detail: '🇰🇷–🇺🇸, 🇨🇦–🇪🇪, 🇨🇿–🇨🇭, 🇳🇴–🇮🇹', medal: false, finnish: false, broadcasts: ['hbo-max'] },
            { time: '20:30', sport: 'lumilautailu', name: 'M Big Air, finaali', detail: 'Rene Rinnekangas?', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-76891313' },
    ...
    // ========== MAANANTAI 9.2. ==========
    {
        ...
        events: [
            ...
            { time: '11:30', sport: 'alppihiihto', name: 'M Joukkuekilpailu, syöksylasku', detail: 'Elian Lehto', medal: false, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77008972' },
            ...
            { time: '13:30', sport: 'freestylehiihto', name: 'N Slopestyle, finaali', detail: 'Anni Kärävä?', medal: true, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77008978' },
            { time: '15:00', sport: 'alppihiihto', name: 'M Joukkuekilpailu, pujottelu', detail: 'Eduard Hallberg', medal: true, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77008981' },
            ...
            { time: '17:40', sport: 'jaakiekko-naiset', name: '🇩🇪–🇫🇷', detail: 'B-lohko', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77008986' },
            ...
            { time: '20:00', sport: 'makihyppy', name: 'M Normaalimäki', detail: '', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768502' },
            { time: '20:20', sport: 'taitoluistelu', name: 'Jäätanssi, rytmitanssi', detail: 'Turkkila/Versluis', medal: false, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77008998' },
    ...
    // ========== TIISTAI 10.2. ==========
    {
        ...
        events: [
            ...
            { time: '12:15', sport: 'freestylehiihto', name: 'M Kumparelasku, karsinta 1', detail: 'Suomen kumparelaskijat', medal: false, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77062124' },
            { time: '12:45', sport: 'maastohiihto', name: 'M/N Sprintti (p), erävaihe', detail: '', medal: false, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768170' },
            ...
            { time: '13:30', sport: 'freestylehiihto', name: 'M Slopestyle, finaali', detail: '', medal: true, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77062132' },
            ...
            { time: '18:00', sport: 'kelkkailu', name: 'N Yksikkö, laskut 3-4', detail: '', medal: true, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77062163' },
            { time: '19:05', sport: 'curling', name: 'Sekajoukkue, loppuottelu', detail: '', medal: true, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77062169' },
            ...
            { time: '19:45', sport: 'makihyppy', name: 'Sekajoukkuekilpailu', detail: 'Suomen joukkue', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768501' },
            ...
            { time: '22:10', sport: 'jaakiekko-naiset', name: '🇫🇮–🇨🇭', detail: 'A-lohko', medal: false, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77062193' }
        ]
    },
    // ========== KESKIVIIKKO 11.2. - LEIJONAT ALOITTAA ==========
    {
        ...
        events: [
            ...
            { time: '11:00', sport: 'yhdistetty', name: 'M Mäkiosuus, normaalimäki', detail: 'Ilkka Herola ym.', medal: false, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76771602' },
            ...
            { time: '14:45', sport: 'yhdistetty', name: 'M Normaalimäki/10 km', detail: 'Ilkka Herola ym.', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76771593' },
            ...
            { time: '15:15', sport: 'ampumahiihto', name: 'N Normaalimatka 15 km', detail: 'Suvi Minkkinen ym.', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768440' },
            { time: '17:40', sport: 'jaakiekko-miehet', name: '🇸🇰–🇫🇮', detail: 'B-lohko', medal: false, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77062606' },
    ...
    // ========== TORSTAI 12.2. ==========
    {
        ...
        events: [
            ...
            { time: '11:00', sport: 'freestylehiihto', name: 'M Kumparelasku, karsinta 2', detail: 'Suomen kumparelaskijat', medal: false, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77067582' },
            ...
            { time: '17:40', sport: 'jaakiekko-miehet', name: '🇨🇿–🇨🇦', detail: 'A-lohko', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77067607' },
            ...
            { time: '20:30', sport: 'lumilautailu', name: 'N Halfpipe, finaali', detail: '', medal: true, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77067611' },
            ...
            { time: '22:10', sport: 'jaakiekko-miehet', name: '🇱🇻–🇺🇸', detail: 'C-lohko', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77067617' },
    ...
    // ========== PERJANTAI 13.2. - SUOMI vs RUOTSI ==========
    {
        ...
        events: [
            ...
            { time: '13:00', sport: 'maastohiihto', name: 'M 10 km (v)', detail: 'Iivo Niskanen ym.', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768166' },
            ...
            { time: '13:10', sport: 'jaakiekko-miehet', name: '🇫🇮–🇸🇪', detail: 'B-lohko', medal: false, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77070049', yletv2Url: 'https://areena.yle.fi/1-76771695' },
            ...
            { time: '15:00', sport: 'ampumahiihto', name: 'M Pikamatka 10 km', detail: 'Tero Seppälä ym.', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768452' },
            ...
            { time: '20:00', sport: 'taitoluistelu', name: 'M Vapaaohjelma', detail: '', medal: true, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77070594' },
            ...
            { time: '22:10', sport: 'jaakiekko-miehet', name: '🇨🇦–🇨🇭', detail: 'A-lohko', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77071287' },
    ...
    // ========== LAUANTAI 14.2. ==========
    {
        ...
        events: [
            ...
            { time: '11:00', sport: 'alppihiihto', name: 'M Suurpujottelu', detail: 'Eduard Hallberg', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max', 'eurosport1'], yleareenanUrl: 'https://areena.yle.fi/1-77073086', yletv2Url: 'https://areena.yle.fi/1-76767824' },
            ...
            { time: '12:46', sport: 'freestylehiihto', name: 'N Parikumpareet, finaali', detail: '', medal: true, finnish: false, broadcasts: ['yle-areena', 'hbo-max'] },
            { time: '13:00', sport: 'maastohiihto', name: 'N Viesti 4x7,5 km', detail: 'Suomen naisjoukkue', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768178' },
            ...
            { time: '14:30', sport: 'alppihiihto', name: 'M Suurpujottelu, 2. kierros', detail: 'Eduard Hallberg', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77073168', yletv2Url: 'https://areena.yle.fi/1-76767822' },
            ...
            { time: '15:45', sport: 'ampumahiihto', name: 'N Pikamatka 7,5 km', detail: 'Suvi Minkkinen ym.', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768447' },
            ...
            { time: '16:40', sport: 'jaakiekko-naiset', name: 'Puolivälierä 3', detail: '', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77073249' },
            { time: '17:00', sport: 'pikaluistelu', name: 'M 500 m', detail: '', medal: true, finnish: false, broadcasts: ['yle-areena', 'hbo-max'] },
            { time: '17:40', sport: 'jaakiekko-miehet', name: '🇫🇮–🇮🇹', detail: 'B-lohko', medal: false, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77073233' },
            ...
            { time: '18:45', sport: 'makihyppy', name: 'M Suurmäki', detail: '', medal: true, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77073329' },
            { time: '20:05', sport: 'curling', name: 'N Alkusarja', detail: '🇨🇦–🇨🇭, 🇯🇵–🇺🇸, 🇰🇷–🇩🇰, 🇮🇹–🇸🇪', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'] },
            ...
            { time: '21:10', sport: 'jaakiekko-naiset', name: 'Puolivälierä 4', detail: '', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77073347' },
    ...
    // ========== SUNNUNTAI 15.2. ==========
    {
        ...
        events: [
            ...
            { time: '19:45', sport: 'makihyppy', name: 'N Suurmäki', detail: 'Suomen naishyppääjät', medal: true, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77074324' },
            { time: '20:05', sport: 'curling', name: 'M Alkusarja', detail: '🇨🇳–🇨🇦, 🇳🇴–🇺🇸, 🇮🇹–🇨🇿, 🇬🇧–🇨🇭', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'] },
            ...
            { time: '20:30', sport: 'freestylehiihto', name: 'M Big Air, karsinta', detail: '', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77074330' },
            ...
            { time: '22:10', sport: 'jaakiekko-miehet', name: '🇺🇸–🇩🇪', detail: 'C-lohko', medal: false, finnish: false, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77074336' }
        ]
    },
    // ========== MAANANTAI 16.2. - PUJOTTELU ==========
    {
        ...
        events: [
            ...
            { time: '20:00', sport: 'makihyppy', name: 'M Superjoukkue', detail: '', medal: true, finnish: true, broadcasts: ['yle-areena', 'hbo-max'], yleareenanUrl: 'https://areena.yle.fi/1-77074793' },
    ...
    // ========== TIISTAI 17.2. ==========
    {
        ...
        events: [
            ...
            { time: '11:00', sport: 'yhdistetty', name: 'M Mäkiosuus, suurmäki', detail: 'Ilkka Herola ym.', medal: false, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76771603' },
            ...
            { time: '14:45', sport: 'yhdistetty', name: 'M Suurmäki/10 km', detail: 'Ilkka Herola ym.', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76771595' },
            ...
            { time: '15:30', sport: 'ampumahiihto', name: 'M Viesti 4x7,5 km', detail: 'Suomen miesjoukkue', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768439' },
    ...
    // ========== KESKIVIIKKO 18.2. - PUOLIVÄLIERÄT ==========
    {
        ...
        events: [
            ...
            { time: '15:45', sport: 'ampumahiihto', name: 'N Viesti 4x6 km', detail: 'Suomen naisjoukkue', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768444' },
    ...
    // ========== LAUANTAI 21.2. ==========
    {
        ...
        events: [
            ...
            { time: '15:15', sport: 'ampumahiihto', name: 'N Yhteislähtö 12,5 km', detail: 'Suvi Minkkinen ym.', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'], yletv2Url: 'https://areena.yle.fi/1-76768446' },
