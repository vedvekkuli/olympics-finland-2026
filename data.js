...
const olympicSchedule = [
    ...
    // ========== TIISTAI 10.2. ==========
    {
        ...
        events: [
            ...
            { time: '14:09', sport: 'maastohiihto', name: 'N Sprintti (p), finaali', detail: 'Suomalaisia mukana?', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'] },
            { time: '14:21', sport: 'maastohiihto', name: 'M Sprintti (p), finaali', detail: 'Suomalaisia mukana?', medal: true, finnish: true, broadcasts: ['yle-tv2', 'yle-areena', 'hbo-max'] },
